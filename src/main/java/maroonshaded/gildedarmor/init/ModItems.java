...
public class ModItems
{
    ...
    public static final Item GILDED_ENDERITE_CHESTPLATE = addItem("gilded_enderite_chestplate", new GildedArmorItem(ModArmorMaterial.GILDED_ENDERITE, ArmorItem.Type.CHESTPLATE, new Item.Settings().fireproof()));
    public static final Item GILDED_ENDERITE_LEGGINGS = addItem("gilded_enderite_leggings", new GildedArmorItem(ModArmorMaterial.GILDED_ENDERITE, ArmorItem.Type.LEGGINGS, new Item.Settings().fireproof()));
